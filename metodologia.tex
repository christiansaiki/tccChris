...
Após planejar como realizar cada teste com o intuito de testar as hipóteses de valor, a equipe da Beeconnect deverá ir a campo responder cada uma das suposições geradas. É a aplicação do conceito do \textit{Genchi Gembutsu} de "saia e veja por si mesmo" utilizado na manufatura enxuta e mencionado por \citeonline{leanstartup}.
