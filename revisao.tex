...
\centerline{\includegraphics[scale=0.75]{img/desenvolvimento_de_clientes}}
...
\centerline{\includegraphics[scale=0.75]{img/descoberta_do_cliente}}
...
\centerline{\includegraphics[scale=0.75]{img/validacao_do_cliente}}
